const bubble = {
    ...
    init: function() {
        bubble.handleCreateAboutBubble();
        bubble.handleCreateInfoBubble();
        bubble.handleAddInfoBubble();
},
...
handleCreateInfoBubble: function (cardElement, pokemon, pokemons) {
    ...
    const handleClickOutside = function (event) {
        if (!infoBubble.contains(event.target) && event.target !== cardElement) {
            infoBubble.style.display = 'none';
            document.removeEventListener('keydown', handleKeyDown);
            document.removeEventListener('click', handleClickOutside);
        }
    ...
    cardElement.addEventListener('click', function (event) {
        ...
        if (bubble.currentInfoBubble) {
            bubble.currentInfoBubble.style.display = 'none';
        }
        infoBubble.style.display = (infoBubble.style.display === 'none' || infoBubble.style.display === '') ? 'block' : 'none';
        bubble.currentInfoBubble = infoBubble;

        bubble.handleAddInfoBubble(infoBubble, pokemon, pokemons);
...
handleAddInfoBubble: function (infoBubble, pokemon, pokemons) {
    ...
    // Création d'un conteneur pour les conditions d'évolution
    ...
    // Vérification et gestion des évolutions précédentes
    ...
    // Vérification et gestion des évolutions suivantes
    ...
    // Ajout du conteneur des conditions d'évolution au conteneur principal
...
handleCreateAboutBubble: function () {
    ...
    about.addEventListener('click', function (event) {
        ...
        if (bubble.currentAboutBubble) {
            bubble.currentAboutBubble.style.display = 'none';
        }
